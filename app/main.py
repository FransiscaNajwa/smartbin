...
from app.LoginPage import show_login_page
from app.RegisterPage import show_register_page
from app.HomePage import show_home_page
from app.ProfilePage import show_profile_page
from app.RiwayatPage import show_riwayat_page
from app.NotifikasiPage import show_notifikasi_page
...
elif page == "RiwayatPage":
    show_riwayat_page(go_to)
